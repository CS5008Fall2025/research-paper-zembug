...
One ant, one iteration: O(n^2)

𝑘  ants, one iteration: O(k * n^2)

𝑘  ants, 𝑡 iterations: O(t * k * n^2)

Simplified reporting: O(k * n^2), assuming a fixed number of iterations  [2]
